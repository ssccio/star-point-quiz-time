...
export const sampleQuestions = [
  ...
  },
  {
    ...
    options: ['Albert Pike', 'Dr. Rob Morris', 'Albert Mackey', 'Joseph Warren'],
  ...
  },
  {
    ...
    options: ['Ruth the Moabitess', 'Queen Esther', 'Martha of Bethany', 'Mary Magdalene'],
  ...
  },
  {
    ...
    options: ['Charity and benevolence', 'Masonic degrees', 'Political involvement', 'Business networking'],
